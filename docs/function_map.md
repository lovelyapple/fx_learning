...
| RSIサブチャート | src/components/CandlestickChart.tsx | lightweight-charts | ✅ 実装済 |
...
| AI参照足マーカー表示（オレンジ矢印） | src/components/CandlestickChart.tsx | lightweight-charts | ✅ 実装済 |
| AIチャットUI（⌘Enter送信・履歴保持） | src/components/ChatPanel.tsx | services/api | ✅ 実装済 |
...
| パターン集ページ | src/components/PatternLibrary.tsx | data/candlePatterns | ✅ 実装済 |
| パターン分析サイドバー | src/components/PatternSidebar.tsx | data/candlePatterns | ✅ 実装済 |
| 用語集ページ | src/components/Glossary.tsx | — | ✅ 実装済 |
| ローソク足パターン定義・マッチング | src/data/candlePatterns.ts | — | ✅ 実装済 |
